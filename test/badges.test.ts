...
const errSpecNotRegistered = '_mint__specIsNotRegistered()'
const errSpecAlreadyRegistered = 'createSpecAsRaftOwner_specAlreadyRegistered()'
const errNotRaftOwner = 'createSpecAsRaftOwner_unauthorized()'
