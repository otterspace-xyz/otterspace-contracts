...
contract BadgeStorage is ERC165Upgradeable, UUPSUpgradeable, OwnableUpgradeable, EIP712Upgradeable {
  ...
  function setUsedVoucherHashId(uint256 _voucherHashId) internal virtual {
    usedHashes.set(_voucherHashId);
  }

  function getUsedVoucherHash(uint256 _voucherHashId) internal virtual returns (bool) {
    return usedHashes.get(_voucherHashId);
  }

  function unsetUsedVoucherHashId(uint256 _voucherHashId) internal virtual {
